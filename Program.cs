...
string iotHubHostName = "<IoTHubHostname>.azure-devices.net";
int messageId = 1;
...
while (true)
{
    try
    {
        ...
        var telemetryDataPoint = new
        {
            messageId = messageId++,
            deviceId = deviceId,
            Temp1 = tempValue.ToString(),
            Temp2 = temp2Value.ToString(),
            Pressure = preValue.ToString(),
            Humidity = humValue.ToString(),
            Acceleration = accValue,
            AngularRate = angValue,
            MagneticInduction = magValue,
            Altitude = altValue.ToString()
        };
